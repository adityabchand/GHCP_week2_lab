...
- Always use British english spellings and grammar
- When using or creating code samples always comment code samples inline so that it is documented and easy to understand for the students
